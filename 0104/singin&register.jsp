...
%>
        ...
        <div class="insideleft">
          <div class="box_bg">
            <div class="body_text">
              ...
              <form action="logincheck.jsp" method="post" id="form2">
              <p>
                <input class="e_w_text " type="email" placeholder="Email" size="20" autocomplete="off" name="Email">
              </p>
              <p>
              ...
              <p>
                <button type="submit" form="form2" class="e_w_text" name="singin">登入</button>
                <button onclick="window.location.href = 'mansingin.jsp';" name="singin">管理者登入</button>
              </p>
            <div>
                <!--幻燈片-->
                <div class="list">
    ...
    <form action="register.jsp" method="post" id="form1">
              <p>
                <input class="e_w_text" type="text" placeholder="Name 名字" size="20" autocomplete="off" name="Name">
              </p>
              <p>
                <input class="e_w_text" type="email" placeholder="Email 電子信箱" size="20" autocomplete="off"
                  name="Register_Email">
              </p>
              <p>
                <input class="e_w_text" type="password" placeholder="password 輸入密碼" autocomplete="off"
                  name="Register_password">
              </p>
              <p>
                <input class="e_w_text" type="password" placeholder="password 確認密碼" autocomplete="off"
                  name="Register_repassword">
              </p>

              <p>
                <input class="e_w_text" type="date" name="Date">
                <span class="e_w_text">出生年月日</span>
              </p>
              <p>
                <input class="e_w_text" placeholder="居住地址" size="20" name="location">
              </p>


              <p>
                <input type="submit" value="註冊" form="form1" class="e_w_text">
              </p>
    </form>
...
<%
      ...
      else
      {
        ...
        out.println("window.document.location.href='member profile.jsp';");
        out.println("</SCRIPT>");
      }
}
else
{
  out.println("<SCRIPT LANGUAGE='JavaScript'>");
  out.println("window.document.location.href='manager.jsp';");
  out.println("</SCRIPT>");
}
%>