...
<head>
  ...
  <title>member profile_change</title>
  ...
  <div class=" content">
    <div class=" insideleft">
      <div class=" textinside">
        ...
        <div class=" c_w">
          <p>
<form action="add_profile_change.jsp" method="post" id="form1">
            名稱：

            <span style="margin-left: 50px;"><input type="text" value="<%=NAME%>" name="name"></span>
          </p>
        </div>
        <div class=" e_w">
          E-mail：
          <input type="text" value="<%=EMAIL%>" name="E-mail" class=" e_w_text" disabled="disabled">

        </div>
        <div class="c_w">
          <p>
            生日：
            <span style="margin-left: 50px;"><input type="date" value="<%=DATE%>" name="date"></span>
          </p>

          <p>
            居住地：

            <input class="e_w_text " type="text" value="<%=ADDRESS%>" size="30" name="relocation">
</form>
          </p>

          <p>
            <button form="form1" class=" c_w_text" name="Rechange" style="border-radius: 90px; margin-left: 250px;">送出更動</button>
