...
<body>
 ...
 <%
    String sql1 = "SELECT * FROM product WHERE pdId=48 GROUP BY pdKind";
    ...
    String sql2 = "SELECT * FROM product WHERE pdKind='recoder'";
...
%> 
      ...
      <div>
        ...
        <p>
          <div class="word">款式：
            <a href="#img1"> <button name="recoder" class="button_w" disabled>SJ5000X行車紀錄器</button></a>
          </div>
        </p>
        <p>
                    <div class="word">
