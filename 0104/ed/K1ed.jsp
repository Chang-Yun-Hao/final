...
<%
    String sql1 = "SELECT * FROM product WHERE pdId=1 GROUP BY pdKind";
    ...
    String sql2 = "SELECT * FROM product WHERE pdKind='K1'";
...
<input type="hidden" name="pdid" id="goodId" value="<%=ID%>">
        ...
        <p>
          <div>
            ...
            <button class="button_w button_pay" type="submit" name="Checkout">直接結帳</button>
</form>
