...
<body>
 ...
 <%
    String sql1 = "SELECT * FROM product WHERE pdId=13 GROUP BY pdKind";
    ...
    String sql2 = "SELECT * FROM product WHERE pdKind='GT-Air II'";
...
%> 
      ...
      <div>
        ...
        <p>
          <div class="word">顏色選取：
            <a href="#img1"> <button name="GT-Air" class="button_w"onclick = "changeId(13);changeStock(<%=STOCK1%>)">白</button></a>
            <a href="#img2"> <button name="GT-Air" class="button_w"onclick = "changeId(14);changeStock(<%=STOCK2%>)">藍</button></a>
            <a href="#img3"> <button name="GT-Air" class="button_w"onclick = "changeId(15);changeStock(<%=STOCK3%>)">黑橘</button></a>
          </div>
        </p>
