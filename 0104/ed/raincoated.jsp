...
<body>
 ...
 <%
    String sql1 = "SELECT * FROM product WHERE pdId=50 GROUP BY pdKind";
    ...
    String sql2 = "SELECT * FROM product WHERE pdKind='raincoat'";
...
%> 
      ...
      <div>
        ...
        <p>
          <div class="word">款式：
            <a href="#img1"> <button name="raincoat" class="button_w" disabled>X武士兩件式雨衣</button></a>
          </div>
        </p>
        <p>
          <div class="word">
      ...
      <div>
        ...
        <div style="text-align: center; float: right;margin-top: 5px;margin-right: 20px;">
          ...
          https://www1.cycu.edu.tw/
            ...
            <button class="button_w button_pay" name="Checkout" onclick="history.back()">回上一頁</button>
