    ...
    try{
        ...
        if(con.isClosed())
        ...
        else
          {
            ...
            String sqlP = "SELECT * FROM product WHERE pdKind = 'x14' GROUP BY pdKind";
            ...
            String sqlS1 = "SELECT * FROM product WHERE pdId = '18' ";
            ...
            String sqlS2 = "SELECT * FROM product WHERE pdId = '19' ";
            ...
            String sqlS3 = "SELECT * FROM product WHERE pdId = '20' ";
            ...
            String sqlS4 = "SELECT * FROM product WHERE pdId = '21' ";
            ResultSet rsS4 = con.createStatement().executeQuery(sqlS4);
            while(rsS4.next())
            {
              STOCK4 = rsS4.getString("pdStock");
            }
%>
<!DOCTYPE html>
<html lang="en">
  ...
  <div class="content">
    <div class="insideleft">
      <div>
        ...
        <div title="點擊預覽">
          <img onclick="showBgImg(this)" class="thum-img" src="../images/products/see/shoei/x14/x14-B.jpg">
          <div class="box2" id="img1"><img src="../images/products/see/shoei/x14/x14-B.jpg" class="thum-img"
              onclick="showBgImg(this)" /></div>
          <div class="box2" id="img2"><img src="../images/products/see/shoei/x14/x14-w.jpg" class="thum-img"
              onclick="showBgImg(this)" /></div>
          <div class="box2" id="img3"><img src="../images/products/see/shoei/x14/x14-Blue.jpg" class="thum-img"
              onclick="showBgImg(this)" /></div>
          <div class="box2" id="img4"><img src="../images/products/see/shoei/x14/x14-R.jpg" class="thum-img"
              onclick="showBgImg(this)" /></div>
        </div>
      ...
      <div>
        ...
        <p>
          <div class="word1">
            NT$ <%=PRICE%>
            <i class="fas fa-star star">5.0</i>
          </div>
        </p>
        <p>
          <div class="word">顏色選取：
            <a href="#img1"> <button name="X14_1" class="button_w" onclick = "changeId(18);changeStock(<%=STOCK1%>)">經典霧面黑</button></a>
            <a href="#img2"> <button name="X14_2" class="button_w" onclick = "changeId(19);changeStock(<%=STOCK2%>)">經典白</button></a>
            <a href="#img3"> <button name="X14_3" class="button_w" onclick = "changeId(20);changeStock(<%=STOCK3%>)">PULL&BEAR 鬼神款</button></a>
            <a href="#img4"> <button name="X14_4" class="button_w" onclick = "changeId(21);changeStock(<%=STOCK4%>)">PULL&BEAR 93</button></a>
          </div>
        </p>
        <script>
function changeId(i)
    ...
    <div class="content">
        ...
        <p>
          ...
          <div class="box1">
            <div class="note_w">
              ...
              經過MOTO GP 所代表最頂級的公路比賽歷練而來的SHOEI 賽道安全帽〔X系列〕保障高安全性的同時，從頂級賽道支援中獲得的最先端技術，毫無保留的投入外觀、面鏡、內裝、空氣導流裝置，全部煥然一新。
            </div>
            <p>
              <img class="notebox" src="../images/products/note/x14.jpg">
            </p>
          </div>
        </p>
      </div>
      <div class="insideleft">
        ...
        <input type="hidden" name="PDID" value="<%=ID%>">  <!--傳到後端-->
          ...
          <hr>
          <%
        String sqlm = "SELECT message.msgId, member.memName, message.msgContent, message.msgDate FROM message JOIN `member` ON message.memId = member.memId WHERE pdId = '18' ORDER BY message.msgId DESC;";
    ...
    <footer>
      <div>
        ...
        <img src="../images/logo_index.png"
          style="width: 80px;height: 80px;float: left;margin-left: 20px; margin-top: 10px;">
