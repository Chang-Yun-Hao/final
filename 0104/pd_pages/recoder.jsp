    ...
    try{
        ...
        if(con.isClosed())
        ...
        else
          {
            ...
            String sqlP = "SELECT * FROM product WHERE pdKind = 'recoder' GROUP BY pdKind";
            ...
            String sqlS1 = "SELECT * FROM product WHERE pdId = '48' ";
  ...
  <div class="content">
    <div class="insideleft">
      <div>
        ...
        <div title="點擊預覽">
          <img onclick="showBgImg(this)" class="thum-img" src="../images/products/see/EX/recoder1.png">
        </div>
      ...
      <div>
        ...
        <p>
          <div class="word">顏色選取：
            <a href="#img1"> <button name="recoder" class="button_w">SJ 5000X Elite</button></a>
          </div>
        </p>
        <script>
function changeId(i)
    ...
    <div class="content">
        ...
        <p>
          ...
          <div class="box1">
            <div class="note_w">
              ...
              兩吋大螢幕
              4K 24fps / 2K 30fps /1080p 60fps 攝影
              1200萬畫素
              具備Wi-Fi與手機連線，透過SJCAM app遙控、下載影像
              陀螺儀防手震 （電子三軸）
              FOV 攝影角度調整
              慢動作高速攝影
              縮時攝影
              ...
              商品規格
              鏡頭：SONY IMX078
              標準檢驗局商品檢驗通過：BSMI字號 D39755
              NCC合格字號:CCAJ15LP5601T5
              最高支援到128G記憶卡

            </div>
            <p>
              <img class="notebox" src="../images/products/EX/recoder1.png.jpg">
            </p>
          </div>
      ...
      <div class="insideleft">
        ...
        <input type="hidden" name="PDID" value="<%=ID%>">  <!--傳到後端-->
          ...
          <hr>
          <%
        String sqlm = "SELECT message.msgId, member.memName, message.msgContent, message.msgDate FROM message JOIN `member` ON message.memId = member.memId WHERE pdId = '48' ORDER BY message.msgId DESC;";
