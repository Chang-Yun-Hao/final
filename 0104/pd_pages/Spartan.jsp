    ...
    try{
        ...
        if(con.isClosed())
        ...
        else
          {
            ...
            String sqlP = "SELECT * FROM product WHERE pdKind = 'Spartan' GROUP BY pdKind";
            ...
            String sqlS1 = "SELECT * FROM product WHERE pdId = '25' ";
  ...
  <div class="content">
    <div class="insideleft">
      <div>
        ...
        <div title="點擊預覽">
          <img onclick="showBgImg(this)" class="thum-img"
            src="../images/products/see//shark/Spartan/shark_spartan12_lorenzo_mat_gp_dot_750x750.jpg">
          <div class="box2" id="img1"><img src="../images/products/see//shark/Spartan/shark_spartan_1.jpg"
      ...
      <div>
        ...
        <p>
          <div class="word">顏色選取：
            <a href="#img1"> <button name="SF-2" class="button_w" disabled>野狼款</button></a>
          </div>
        </p>
<script>
function changeId(i)
    ...
    <div class="content">
        ...
        <p>
          ...
          <div class="box1">
            <div class="note_w">
              ...
              這款全罩式運動頭盔具有SHARK的核心及創新。精緻的設計和優化的空氣動力學性能，彰顯了其靈活而堅定的特性。快速防霧系統，可將鏡片打開並固定到抗霧位置，提升防霧效果。自動密封功能：將鏡片密封在頭盔上，提供更好的隔音效果，並使頭盔具有防水，防寒能力。

            </div>
            <p>
              <img class="notebox" src="../images/products/note/spartan.jpg">
            </p>
          </div>
        </p>
      </div>
      <div class="insideleft">
        ...
        <input type="hidden" name="PDID" value="<%=ID%>">  <!--傳到後端-->
          ...
          <hr>
          <%
        String sqlm = "SELECT message.msgId, member.memName, message.msgContent, message.msgDate FROM message JOIN `member` ON message.memId = member.memId WHERE pdId = '25' ORDER BY message.msgId DESC;";
