    ...
    try{
        ...
        if(con.isClosed())
        ...
        else
          {
              ...
              String sqlP = "SELECT * FROM product WHERE pdKind = 'GT-Air II' GROUP BY pdKind";
              ...
              String sqlS1 = "SELECT * FROM product WHERE pdId = '13' ";
              ...
              String sqlS2 = "SELECT * FROM product WHERE pdId = '14' ";
              ...
              String sqlS3 = "SELECT * FROM product WHERE pdId = '15' ";
    ...
    <div class="insideleft">
      <div>
        ...
        <div>
          <div title="點擊預覽">
            <img onclick="showBgImg(this)" class="thum-img"
              src="../images/products/see/shoei/GT-Air II/shoei_gt_air_ii_750x750 (2).jpg">
            <div class="box2" id="img7"><img
                src="../images/products/see/shoei/GT-Air II/shoei_gt_air_ii_rollover.jpg"
                class="thum-img" onclick="showBgImg(this)" /></div>
            <div class="box2" id="img11"><img
                src="../images/products/see/shoei/GT-Air II/shoei_gt_air_ii_panorama_helmet_750x750 (1).jpg" class="thum-img"
        ...
        <div>
          ...
          <p>
            <div class="word">顏色選取：
              <a href="#img3"> <button class="button_w" name="GT-Air" onclick = "changeId(13);changeStock(<%=STOCK1%>)">白</button></a>
            <a href="#img7"> <button class="button_w" name="GT-Air" onclick = "changeId(14);changeStock(<%=STOCK2%>)">藍</button></a>
            <a href="#img11"> <button class="button_w" name="GT-Air" onclick = "changeId(15);changeStock(<%=STOCK3%>)">黑橘</button></a>
            </div>
          </p>
<script>
function changeId(i)
...
<input type="hidden" name="pdid" id="goodId" value="<%=ID%>">
      ...
      <div class="content">
          ...
          <p>
            ...
            <div class="box1">
              <div class="note_w">
                ...
                富有侵略性的x正統設計象徵著該系列GT-Air
                II繼承了顳部的形狀，這是GT-Air的象徵性設計，同時具有更前衛的外殼設計，與通風部件整合在一起，並從頭部的前部向後部流動。尖銳的下巴線和專用的通信系統安裝空間增加了重點。
              </div>
              <p>
                <img class="notebox" src="../images/products/note/GT-Air_II.jpg">
              </p>
            </div>
        ...
        <div class="insideleft">
            ...
            <hr>
<%
        String sqlm = "SELECT message.msgId, member.memName, message.msgContent, message.msgDate FROM message JOIN `member` ON message.memId = member.memId WHERE pdId = '13' ORDER BY message.msgId DESC;";
