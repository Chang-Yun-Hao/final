    ...
    try{
        ...
        if(con.isClosed())
        ...
        else
          {
            ...
            String sqlP = "SELECT * FROM product WHERE pdKind = 'RF-1200' GROUP BY pdKind";
            ...
            String sqlS1 = "SELECT * FROM product WHERE pdId = '16' ";
            ...
            String sqlS2 = "SELECT * FROM product WHERE pdId = '17' ";
  ...
  <div class="content">
    <div class="insideleft">
        ...
        <div title="點擊預覽">
          <div>
            <img onclick="showBgImg(this)" class="thum-img"
              src="../images/products/see/shoei/RF-1200/RF-1200-02.jpg">
          </div>
          <div class="box2" id="img1"><img src="../images/products/see/shoei/RF-1200/RF-1200-02.jpg"
              class=" thum-img" onclick="showBgImg(this)" />
          </div>
          <div class="box2" id="img2"><img src="../images/products/see/shoei/RF-1200/RF-1200-01.jpg"
              class=" thum-img" onclick="showBgImg(this)" />
          </div>
        </div>
        <script>
      ...
      <div>
        ...
        <p>
          <div class="word">顏色選取：
            <a href="#img1"> <button name="RF-1200_1" class="button_w" onclick = "changeId(16);changeStock(<%=STOCK1%>)">RF-1200 (蜘蛛網)</button></a>
            <a href="#img2"> <button name="RF-1200_2" class="button_w" onclick = "changeId(17);changeStock(<%=STOCK2%>)">RF-1200 (美國國旗版)</button></a>
          </div>
        </p>
<script>
function changeId(i)
    ...
    <div class="content">
        ...
        <p>
          ...
          <div class="box1">
            <div class="note_w">
              ...
              在最負盛名的高級全罩式摩托車頭盔譜系中，RF-1200與之前的許多RF前輩一樣，是頭盔性能和技術的新巔峰。SHOEI的RF-1200是一款輕便，緊湊，流線型的頭盔，具有下一代功能，可在道路的各個方面以及某些方面做出規定。但是，不要僅僅因為評論家的面子價值而受到評論家的好評。該輪到您體驗騎RF-1200的刺激了。
            </div>
            <p>
              <img class="notebox" src="../images/products/note/RF-1200.jpg">
            </p>
          </div>
      ...
      <div class="insideleft">
        ...
        <input type="hidden" name="PDID" value="<%=ID%>">  <!--傳到後端-->
          ...
          <hr>
          <%
        String sqlm = "SELECT message.msgId, member.memName, message.msgContent, message.msgDate FROM message JOIN `member` ON message.memId = member.memId WHERE pdId = '16' ORDER BY message.msgId DESC;";
