    ...
    try{
        ...
        if(con.isClosed())
        ...
        else
          {
            ...
            String sqlP = "SELECT * FROM product WHERE pdKind = 'Race R Pro' GROUP BY pdKind";
            ...
            String sqlS1 = "SELECT * FROM product WHERE pdId = '22' ";
            ...
            String sqlS2 = "SELECT * FROM product WHERE pdId = '23' ";
  ...
  <div class="content">
    <div class="insideleft">
      <div>
        ...
        <div title="點擊預覽">
          <div>
            <img onclick="showBgImg(this)" class="thum-img" src="../images/products/see/shark/Race R Pro/1.jpg">
          </div>
          <div class="box2" id="img1"><img src="../images/products/see/shark/Race R Pro/1.jpg" class=" thum-img"
              onclick="showBgImg(this)" />
          </div>
          <div class="box2" id="img2"><img src="../images/products/see/shark/Race R Pro/2.jpg" class=" thum-img"
              onclick="showBgImg(this)" />
          </div>
        </div>
        <script>
      ...
      <div>
        ...
        <p>
          <div class="word">顏色選取：
            <a href="#img1"> <button name="Race R Pro1" class="button_w" onclick = "changeId(22);changeStock(<%=STOCK1%>)"> Zarco 2017</button></a>
            <a href="#img2"> <button name="Race R Pro2" class="button_w" onclick = "changeId(23);changeStock(<%=STOCK2%>)"> Carbon Lorenzo 2019</button></a>
          </div>
        </p>
<script>
function changeId(i)
    ...
    <div class="content">
        ...
        <p>
          ...
          <div class="box1">
            <div class="note_w">
              ...
              世界上第一個獲得FRHPhe-01認證的品牌。
              RACE-R Pro GP FIM RACING 通過（國際摩托車聯合會）最新的FIM標準。
              自2019年6月起在Moto GP和超級摩托車中及2020年所有FIM錦標賽，都將強制要求車手佩戴通過FIM標準的安全帽。

            </div>
            <p>
              <img class="notebox" src="../images/products/note/SHARKRace_R_Pro.jpg">
            </p>
          </div>
      ...
      <div class="insideleft">
        ...
        <input type="hidden" name="PDID" value="<%=ID%>">  <!--傳到後端-->
          ...
          <hr>
<%
        String sqlm = "SELECT message.msgId, member.memName, message.msgContent, message.msgDate FROM message JOIN `member` ON message.memId = member.memId WHERE pdId = '22' ORDER BY message.msgId DESC;";
