    ...
    try{
        ...
        if(con.isClosed())
        ...
        else
          {
            ...
            String sqlP = "SELECT * FROM product WHERE pdKind = 'SF-6' GROUP BY pdKind";
            ...
            String sqlS1 = "SELECT * FROM product WHERE pdId = '30' ";
  ...
  <div class="content">
    <div class="insideleft">
      <div>
        ...
        <div title="點擊預覽">
          <img onclick="showBgImg(this)" class="thum-img"
            src="../images/products/see/SOL/SF-6/sf-6_unicorn_wb_1.jpg">
        </div>
      ...
      <div>
        ...
        <p>
          <div class="word">顏色選取：
            <a href="#img1"> <button name="SF-6" class="button_w" disabled>特別款-藍</button></a>
          </div>
        </p>
        <script>
function changeId(i)
    ...
    <div class="content">
        ...
        <p>
          ...
          <div class="box1">
            <div class="note_w">
              ...
              高強度厚鏡片，提升韌性及剛性。鏡片鎖系統，高速騎乘時更穩定。
              加強型眼鏡溝，讓眼鏡族舒適更有感。浮動式鏡片座設計，增加鏡片與帽體的密合性，提升寧靜度。360°EPS完全防護，包含頭頂保麗龍、兩頰保麗龍及下巴保麗龍。內建EPS藍芽耳機槽，於兩頰保麗龍中預留耳機空間，配戴更舒適。內墨片，又稱內藏鏡、內置鏡片或遮陽鏡，是設計在安全帽內的太陽眼

            </div>
            <p>
              <img class="notebox" src="../images/products/note/SF-6.jpg">
            </p>
          </div>
      ...
      <div class="insideleft">
        ...
        <input type="hidden" name="PDID" value="<%=ID%>">  <!--傳到後端-->
          ...
          <hr>
          <%
        String sqlm = "SELECT message.msgId, member.memName, message.msgContent, message.msgDate FROM message JOIN `member` ON message.memId = member.memId WHERE pdId = '30' ORDER BY message.msgId DESC;";
