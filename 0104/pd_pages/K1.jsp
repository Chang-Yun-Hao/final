    ...
    try{
        ...
        if(con.isClosed())
        ...
        else
          {
              ...
              String sqlP = "SELECT * FROM product WHERE pdKind = 'K1' GROUP BY pdKind";
              ...
              String sqlS1 = "SELECT * FROM product WHERE pdId = '1' ";
              ...
              String sqlS2 = "SELECT * FROM product WHERE pdId = '2' ";
              ...
              String sqlS3 = "SELECT * FROM product WHERE pdId = '3' ";
  ...
  <div class="content">
    <div class="insideleft">
      <div>
        ...
        <div title="點擊預覽">
          <div>
            <img onclick="showBgImg(this)" class="thum-img" src="../images/products/see/AGV/K1/agvk1_helmet_750x750.jpg">
          </div>
          <div class="box2" id="img1"><img src="../images/products/see/AGV/K1/agvk1_helmet_750x750.jpg" class=" thum-img" onclick="showBgImg(this)" />
          </div>
          <div class="box2" id="img2"><img src="../images/products/see/AGV/K1/agvk1_helmet_1800x1800 (1).jpg" class=" thum-img" onclick="showBgImg(this)" />
          </div>
          <div class="box2" id="img3"><img src="../images/products/see/AGV/K1//agvk1_helmet_1800x1800 (3).jpg" class="thum-img" onclick="showBgImg(this)" />
          </div>
        </div>
      ...
      <div>
        ...
        <p>
          <div class="word">顏色選取：
            <a href="#img1"> <button name="K1_B" class="button_w" onclick = "changeId(1);changeStock(<%=STOCK1%>)">黑色</button></a>
            <a href="#img2"> <button name="K1_G" class="button_w" onclick = "changeId(2);changeStock(<%=STOCK2%>)">消光灰</button></a>
            <a href="#img3"> <button name="K1_W" class="button_w" onclick = "changeId(3);changeStock(<%=STOCK3%>)">白色</button></a>
          </div>
        </p>
<script>
function changeId(i)
        ...
        <p>
          ...
          <div class="box1">
            <div class="note_w">
              ...
              依照賽道帽設計，經過空氣力學及空洞測試，尾端擾流板(壓尾)可提昇騎乘表現及高速穩定性。190度全景鏡片具有寬闊的視野及防刮耐磨的特性。舒適的Dry-Comfort內襯皆可拆卸，並在雨天騎乘時達到最小程度的進水與不適感。帽體由4片分離式EPS樹脂組成，可分散撞擊的力道與反彈。
            </div>
            <p>
              <img class="notebox" src="../images/products/note/AGVK1.png">
            </p>
          </div>
...
<%
        String sqlm = "SELECT message.msgId, member.memName, message.msgContent, message.msgDate FROM message JOIN `member` ON message.memId = member.memId WHERE pdId = '1' ORDER BY message.msgId DESC;";
