      ...
      <div>
        ...
        <div title="點擊預覽">
          <img onclick="showBgImg(this)" class="thum-img"
            src="../images/products/see/shark/Skwal 2/shark_skwal2_noxxys_helmet_750x750.jpg">
        </div>
        ...
        <p>
          ...
          <div class="box1">
            <div class="note_w">
              ...
              擁有全新的內部裝潢，配有可充電LED燈，可在道路上提供更高的視野。SKWAL 2 有鮮明的外觀，其擾流板的纖薄運動型設計，再加上空氣動力學優化特性，使其成為運動和性能開發的頭盔。
            </div>
            <p>
              <img class="notebox" src="../images/products/note/Skwal 2.jpg">
            </p>
          </div>
        </p>
      </div>
