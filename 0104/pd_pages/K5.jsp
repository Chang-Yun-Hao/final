    ...
    try{
        ...
        if(con.isClosed())
        ...
        else
          {
            ...
            String sqlP = "SELECT * FROM product WHERE pdKind = 'K5' GROUP BY pdKind";
            ...
            String sqlS1 = "SELECT * FROM product WHERE pdId = '7' ";
            ...
            String sqlS2 = "SELECT * FROM product WHERE pdId = '8' ";
            ...
            String sqlS3 = "SELECT * FROM product WHERE pdId = '9' ";
  ...
  <div class="content">
    <div class="insideleft">
        ...
        <div title="點擊離開預覽">
          <div>
            <img onclick="showBgImg(this)" class="thum-img"
              src="../images/products/see/AGV/K5/agvk5_s_helmet_solid_750x750.jpg">
          </div>
          <div class="box2" id="img1"><img
              src="../images/products/see/AGV/K5/agvk5_s_helmet_solid_750x750.jpg" class=" thum-img"
              onclick="showBgImg(this)" />
          </div>
          <div class="box2" id="img2"><img src="../images/products/see/AGV/K5/agvk5_s_helmet_solid_750x750 (1).jpg"
              class=" thum-img" onclick="showBgImg(this)" />
          </div>
          <div class="box2" id="img3"><img src="../images/products/see/AGV/K5/agvk5_s_helmet_solid_pearl_white_750x750.jpg"
              class="thum-img" onclick="showBgImg(this)" />
          </div>
        </div>
        <script>
      ...
      <div>
        ...
        <p>
          <div class="word">顏色選取：
            <a href="#img1"> <button name="K5" class="button_w" onclick = "changeId(7);changeStock(<%=STOCK1%>)">黑色</button></a>
            <a href="#img2"> <button name="K5" class="button_w" onclick = "changeId(8);changeStock(<%=STOCK2%>)">消光灰</button></a>
            <a href="#img3"> <button name="K5" class="button_w" onclick = "changeId(9);changeStock(<%=STOCK3%>)">白色</button></a>
          </div>
        </p>
        <script>
function changeId(i)
        ...
        <p>
          ...
          <div class="box1">
            <div class="note_w">
              ...
              是一款價格適中的舒適帽款，實用的下拉式內墨片令騎乘時不畏懼豔陽，帽體經過空氣力學及空洞測試，尾端擾流板(壓尾)可提昇騎乘表現及高速穩定性。190度全景鏡片具有寬闊的視野及防刮耐磨的特性。舒適的Dry-Comfort內襯皆可拆卸，並在雨天騎乘時達到最小程度的進水與不適感。帽體由4片分離式EPS樹脂組成，可分散撞擊的力道與反彈。
            </div>
            <p>
              <img class="notebox" src="../images/products/note/AGVK5.png">
            </p>
          </div>
          <div class="insideleft">
            ...
            <input type="hidden" name="PDID" value="<%=ID%>">  <!--傳到後端-->
              ...
              <hr>
<%
        String sqlm = "SELECT message.msgId, member.memName, message.msgContent, message.msgDate FROM message JOIN `member` ON message.memId = member.memId WHERE pdId = '7' ORDER BY message.msgId DESC;";
