    ...
    try{
        ...
        if(con.isClosed())
        ...
        else
          {
            ...
            String sqlP = "SELECT * FROM product WHERE pdKind = 'SF-2' GROUP BY pdKind";
            ...
            String sqlS1 = "SELECT * FROM product WHERE pdId = '28' ";
  ...
  <div class="content">
    <div class="insideleft">
      <div>
        ...
        <div title="點擊預覽">
          <img onclick="showBgImg(this)" class="thum-img" src="../images/products/see/SOL/SF-2/84-1-1_min.jpg">
        </div>
      ...
      <div>
        ...
        <p>
          <div class="word">顏色選取：
            <a href="#img1"> <button name="SF-2" class="button_w" disabled>浮世繪-粉</button></a>
          </div>
        </p>
        <script>
function changeId(i)
    ...
    <div class="content">
        ...
        <p>
          ...
          <div class="box1">
            <div class="note_w">
              ...
              輕量化設計，適合全罩式新手，體型嬌小者也能舒適配戴。可拆式小鼻罩，避免呼吸時的熱氣在鏡片上凝結霧氣，確保視線清晰。與SF-2M為情侶款設計。SF-2帽體較小，適合女生。通過美國DOT及台灣CNS安全認證。DOT測試內容包含穿透測試、撞擊測試、視野角度測試等，為消費者的安全提供保障。扣具採用金屬雙D扣，是國際上公認最安全的扣具。市面上常見的插扣，在撞擊時容易斷裂或彈開，造成安全帽飛脫而失去保護作用。
              <p>
                <img class="notebox" src="../images/products/note/SF-2.jpg">
              </p>
            </div>
          </div>
        </p>
      ...
      <div class="insideleft">
        ...
        <input type="hidden" name="PDID" value="<%=ID%>">  <!--傳到後端-->
          ...
          <hr>
          <%
        String sqlm = "SELECT message.msgId, member.memName, message.msgContent, message.msgDate FROM message JOIN `member` ON message.memId = member.memId WHERE pdId = '28' ORDER BY message.msgId DESC;";
