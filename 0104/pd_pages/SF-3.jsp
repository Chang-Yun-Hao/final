    ...
    try{
        ...
        if(con.isClosed())
        ...
        else
          {
            ...
            String sqlP = "SELECT * FROM product WHERE pdKind = 'SF-3' GROUP BY pdKind";
            ...
            String sqlS1 = "SELECT * FROM product WHERE pdId = '29' ";
  ...
  <div class="content">
    <div class="insideleft">
      <div>
        ...
        <div title="點擊預覽">
          <img onclick="showBgImg(this)" class="thum-img" src="../images/products/see/SOL/SF-3/30-2-1.jpg">
        </div>
      ...
      <div>
        ...
        <p>
          <div class="word">顏色選取：
            <a href="#img1"> <button name="SF-3" class="button_w" disabled>黑橘</button></a>
          </div>
        </p>
        <script>
function changeId(i)
    ...
    <div class="content">
        ...
        <p>
          ...
          <div class="box1">
            <div class="note_w">
              ...
              SOL全罩式安全帽，一直以來堅持安全保護性與舒適包覆性為研發設計重點，2016新款上市SF-3承襲SOL全罩式系列產品優勢，在研發設計上綜合了SF-2M的輕量通風；SF-5的舒適安全包覆性，同時通過DOT、ECE、CNS三項安全規範的合格認證，誕生內外在同等優異的全新帽款
              ─ SF-3，將呈現給您優越的舒適感受。

            </div>
            <p>
              <img class="notebox" src="../images/products/note/SF-3.jpg">
            </p>
          </div>
      ...
      <div class="insideleft">
        ...
        <input type="hidden" name="PDID" value="<%=ID%>">  <!--傳到後端-->
          ...
          <hr>
          <%
        String sqlm = "SELECT message.msgId, member.memName, message.msgContent, message.msgDate FROM message JOIN `member` ON message.memId = member.memId WHERE pdId = '29' ORDER BY message.msgId DESC;";
